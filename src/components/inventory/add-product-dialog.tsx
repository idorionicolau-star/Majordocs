                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {!isCatalogProductSelected && (
                                    <Button
                                        ...
                                        onClick={() => setShowAddCategoryDialog(!showAddCategoryDialog)}
                                    >
                                        <PlusCircle className={cn("h-4 w-4 transition-transform", showAddCategoryDialog && "rotate-45")} />
                                    </Button>
                                )}
                            </div>

                            {showAddCategoryDialog && !isCatalogProductSelected && (
                                <div className="mt-3 p-3 border rounded-lg bg-muted/30 space-y-3 animate-in fade-in slide-in-from-top-2 duration-200">
                                    <div className="space-y-1">
                                        <FormLabel className="text-xs">Nova Categoria</FormLabel>
                                        <Input
...
export function AddProductDialog({ open, onOpenChange, onAddProduct }: AddProductDialogProps) {
    ...
    const handleProductSelect = (productName: string, product?: CatalogProduct) => {
        ...
        if (product) {
            ...
            setIsCatalogProductSelected(false);
            form.setValue('price', 0); // Changed to 0 instead of undefined

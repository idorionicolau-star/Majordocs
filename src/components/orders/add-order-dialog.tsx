...
export function AddOrderDialog({ open, onOpenChange, onAddOrder }: AddOrderDialogProps) {
  ...
  return (
    <ResponsiveDialog
      ...
      title="Nova Encomenda de Produção"
      description="Registe uma nova encomenda para a equipe de produção."
    >
      <div className="max-h-[85vh] overflow-y-auto pr-2">
        <AddOrderForm
          ...
          locations={locations}
          watchedPaymentOption={watchedPaymentOption}
